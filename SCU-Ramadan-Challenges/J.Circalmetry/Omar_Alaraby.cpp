...
void Solve(){
    ...
    double circle = pi * r * r , traingle = .5 * r * sqrt(pow(x + r , 2) - r * r);
    double angle = asin(sqrt(pow(x + r , 2) - r * r) / (x + r)) * 180 / pi + 180;
 
    cout << fixed(6) << circle + traingle - (angle / 360 * pi * r * r) << dl;
}
