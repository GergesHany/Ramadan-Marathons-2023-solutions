...
+---------------------------------------------+
|                                             |
|  Copytright, MinaMagdy, 01/04/2023 (01:34)  |
|                                             |
+---------------------------------------------+
*/
/*
...
int main(void)
{
    ...
    while (testcase--)
    {
        double x, r;
        cin >> x >> r;
        double height = sqrt((r + x) * (r + x) - r * r);
        double triangle_area = height * r * 0.5;
        double half_circle_area = PI * r * r / 2.0;
        double arc_area = atan2(height, r) * r * r / 2.0;
        cout << fixed << half_circle_area + triangle_area - arc_area << endl;
    }
    return 0;
}
